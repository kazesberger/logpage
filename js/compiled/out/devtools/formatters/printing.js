...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23514){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23515,G__23516,seq23514__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23520_SHARP_){
return !((cljs.core.meta.call(null,p1__23520_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23521__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23525){var _e__22474__auto__ = e23525;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e23527){var _e__22474__auto__ = e23527;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23529 = devtools.formatters.state._STAR_current_state_STAR_;
...
var markup_db = cljs.core.get.call(null,map__23530__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23529;
}});
...
;
var temp__5455__auto___23534 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23534)){
var managed_print_level_23535 = temp__5455__auto___23534;
var _STAR_print_level_STAR_23533_23536 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23535;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23533_23536,managed_print_level_23535,temp__5455__auto___23534,writer,opts,job_fn){
return (function (p1__23532_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23532_SHARP_,null);
});})(_STAR_print_level_STAR_23533_23536,managed_print_level_23535,temp__5455__auto___23534,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23533_23536;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1539846786154
