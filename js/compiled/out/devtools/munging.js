...
var o23386 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23386["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23387 = temp__5455__auto____$1;
return (o23387["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22467__auto__ = f;
return (o__22467__auto__["toString"]).call(o__22467__auto__);
} else {
return "";
}
}catch (e23388){var _ = e23388;
return "";
}});
...
try{var o__22467__auto___23390 = t;
(o__22467__auto___23390["cljs$lang$ctorPrWriter"]).call(o__22467__auto___23390,t,writer);
}catch (e23389){var __23391 = e23389;
}
...
var char_code = (function (){var o__22467__auto__ = (new String(char$));
return (o__22467__auto__["charCodeAt"]).call(o__22467__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22467__auto__ = String;
return (o__22467__auto__["fromCharCode"]).call(o__22467__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23392 = num_code;
switch (G__23392) {
case (1):
return (185);
...
var o__22467__auto__ = String;
return (o__22467__auto__["fromCharCode"]).call(o__22467__auto__,superscript_code);
});
/**
...
}catch (e23394){var _e__22474__auto__ = e23394;
return false;
}})())){
...
var vec__23395 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23395,(0),null);
...
var temp__5455__auto____$1 = (o23398["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23399 = temp__5455__auto____$1;
return (o23399["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23402){
var vec__23403 = p__23402;
var ns_detector = cljs.core.nth.call(null,vec__23403,(0),null);
...
var G__23409 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23410 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23409;
remaining_tokens = G__23410;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23400){
var G__23401 = cljs.core.first.call(null,seq23400);
var seq23400__$1 = cljs.core.next.call(null,seq23400);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23401,seq23400__$1);
});
...
var vec__23414 = cljs.core.split_with.call(null,(function (p1__23413_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23413_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23414,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23414,(1),null);
...
var vec__23417 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23417,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23417,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23420 = cljs.core.rest.call(null,remaining_tokens);
var G__23421 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23420;
...
var vec__23424 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23424,(0),null);
var arity = cljs.core.nth.call(null,vec__23424,(1),null);
var vec__23427 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23427,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23427,(1),null);
var vec__23430 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23430,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23430,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23430,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23430,(3),null);
...
var vec__23436 = result;
var munged_ns = cljs.core.nth.call(null,vec__23436,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23436,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23436,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23436,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23436,(4),null);
var arity = cljs.core.nth.call(null,vec__23436,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23440 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23440,(0),null);
var args = cljs.core.nth.call(null,vec__23440,(1),null);
var vec__23443 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23443,(0),null);
var name = cljs.core.nth.call(null,vec__23443,(1),null);
...
var G__23446 = (arity + (1));
var G__23447 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23448){
var vec__23449 = p__23448;
var arity = cljs.core.nth.call(null,vec__23449,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23449,(1),null);
...
return cljs.core.get.call(null,arities,p1__23452_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23453_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___23460 = arguments.length;
var i__4500__auto___23461 = (0);
while(true){
if((i__4500__auto___23461 < len__4499__auto___23460)){
args__4502__auto__.push((arguments[i__4500__auto___23461]));

var G__23462 = (i__4500__auto___23461 + (1));
i__4500__auto___23461 = G__23462;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23456){
var vec__23457 = p__23456;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23457,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23454){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23465__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23465__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23465__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23465__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23466 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23466,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23466,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23466,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23466,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23466,(4),null);
var arity = cljs.core.nth.call(null,vec__23466,(5),null);
...
var o__22467__auto__ = f;
return (o__22467__auto__["getBasis"]).call(o__22467__auto__);
});
/**
...
}catch (e23470){var _e__22474__auto__ = e23470;
...
var G__23471 = (obj[cljs.core.first.call(null,path)]);
var G__23472 = cljs.core.rest.call(null,path);
obj = G__23471;
path = G__23472;
continue;
} else {
...
return (function (accum,p__23473){
var vec__23474 = p__23473;
var bit = cljs.core.nth.call(null,vec__23474,(0),null);
var protocol = cljs.core.nth.call(null,vec__23474,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23477){
var vec__23478 = p__23477;
var ns = cljs.core.nth.call(null,vec__23478,(0),null);
var name = cljs.core.nth.call(null,vec__23478,(1),null);
var selector = cljs.core.nth.call(null,vec__23478,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23483,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23483,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23483,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23481_SHARP_){
return (obj[cljs.core.first.call(null,p1__23481_SHARP_)]);
});})(name,sorted_matches,vec__23483,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1539846785933
